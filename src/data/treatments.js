const smoothLinesImg = '/images/treatment/smoothlines_one.png';
const foreheadlines = '/images/sub-treatments/smooth-lines/forehead-lines.png';
const frownlines = '/images/sub-treatments/smooth-lines/frown-lines.png';
const crowsfeet = '/images/sub-treatments/smooth-lines/crows-feet.png';
const bunnylines = '/images/sub-treatments/smooth-lines/bunny-lines.png';
const gummysmile = '/images/sub-treatments/smooth-lines/gummy-smile.png';
const lipflip = '/images/sub-treatments/smooth-lines/lip-flip.png';
const pebblechin = '/images/sub-treatments/smooth-lines/pebble-chin.png';
const browlift = '/images/sub-treatments/smooth-lines/brow-lift.png';
const masseterbotox = '/images/sub-treatments/smooth-lines/masseter-botox.png';
const traptox = '/images/sub-treatments/smooth-lines/traptox.png';
const migrainebotox = '/images/sub-treatments/smooth-lines/migraine-botox.png';
const hyperhidrosis = '/images/sub-treatments/smooth-lines/hyperhidrosis.png';
const review_one = '/images/sub-treatments/smooth-lines/review_one.png';
const review_two = '/images/sub-treatments/smooth-lines/review_two.png';
const review_three = '/images/sub-treatments/smooth-lines/review_three.png';
const review_four = '/images/sub-treatments/smooth-lines/review_four.png';
const smoothLinesImg_two = '/images/sub-treatments/main_img.png';

const dermalfillers = '/images/sub-treatments/face-sculpt/dermal-fillers.png';
const cheekfillers = '/images/sub-treatments/face-sculpt/cheek-fillers.png';
const jawlinefiller = '/images/sub-treatments/face-sculpt/jawline-filler.png';
const chinfiller = '/images/sub-treatments/face-sculpt/chin-filler.png';
const lipfillers = '/images/sub-treatments/face-sculpt/lip-fillers.png';
const teartroughfiller = '/images/sub-treatments/face-sculpt/tear-trough-filler.png';
const nonsurgicalnose = '/images/sub-treatments/face-sculpt/non-surgical-nose.png';
const templefiller = '/images/sub-treatments/face-sculpt/temple-filler.png';
const nasolabialfiller = '/images/sub-treatments/face-sculpt/nasolabial-filler.png';
const marionettefiller = '/images/sub-treatments/face-sculpt/marionette-filler.png';
const verticaliplines = '/images/sub-treatments/face-sculpt/vertical-lip-lines.png';
const fillerdissolving = '/images/sub-treatments/face-sculpt/filler-dissolving.png';
const facialbalancing = '/images/sub-treatments/face-sculpt/facial-balancing.png';
const main_img_two = '/images/sub-treatments/main_img_two.png';

const skinboosters = '/images/sub-treatments/skin-glow/skin-boosters.png';
const profhilo = '/images/sub-treatments/skin-glow/profhilo.png';
const polynucleotides = '/images/sub-treatments/skin-glow/polynucleotides.png';
const mesotherapy = '/images/sub-treatments/skin-glow/mesotherapy.png';
const prpfacial = '/images/sub-treatments/skin-glow/prp-facial.png';
const hydro2facial = '/images/sub-treatments/skin-glow/hydro2-facial.png';
